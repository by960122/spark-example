...
object KafkaTools {
  ...
  private val consumerConfigs: mutable.Map[String, Object] = mutable.Map[String, Object](
    //  kafka集群位置
    ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG -> PropsTools(Config.KAFKA_BOOTSTRAP_SERVERS),
  ...
  def createProducer(): KafkaProducer[String, String] = {
    ...
    // kafka集群位置
    producerConfigs.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, PropsTools(Config.KAFKA_BOOTSTRAP_SERVERS))
    // kv序列化器
